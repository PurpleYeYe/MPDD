...
if __name__ == '__main__':
    ...
    config = load_config('config_conformer.json')
    opt = Opt(config)

    opt.audiofeature_method = args.audiofeature_method
    opt.videofeature_method = args.videofeature_method
    ...
    # 自动选择模型结构：LSTM vs Transformer
    if opt.name.startswith('conformer_'):
        from models.our.our_model_conformer import ourModel_conformer as ourModel
    else:
